...
const content = ['Curated jobs from 1M+ listings, refreshed every 48 hours', 'Up to 20 human-applied roles per week (no bots, no fluff — just real company sites)', 'Need more? Add extra apps for just $1.5 each', 'Your own dedicated application analyst', 'Personalized with up to 10 filters & 5 job titles']

export default function CTA() {
  return (
    <main className="max-w-[1500px] min-h-screen bg-white">
...
function Tag(){
    return <div className="flex justify-center items-center px-2 border border-primary rounded-3xl">
        Popular
    </div>
}